/*
  ...
  * Filename:     complete_feedback.ino
  * Functions:    
  * Global Variables: joint_1, joint_2, joint_3, joint_4,joint_5,
  * 
  *
*/
...
/*
  *
  * Function Name:  joint_1_angle
  * Input:    no input
  * Output:   no output
  * Logic:    ISR to increment or decrement encoder pulses
  * Example Call:   No function call, Event base interrupt
  *
  */
